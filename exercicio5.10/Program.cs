...
do
{
    ...
    {
        impostoinss += salarioajustado * 0.08;
        salarioajustado = salarioajustado - (salarioajustado * 0.08);
    }

    if (salarioajustado >= 1556.95 && salarioajustado < 2594.93)
    {
        impostoinss += salarioajustado * 0.09;
        salarioajustado = salarioajustado - (salarioajustado * 0.09);
    }

    if (salarioajustado >= 2594.93 && salarioajustado < 5189.92)
    {
        impostoinss += salarioajustado * 0.11;
        salarioajustado = salarioajustado - (salarioajustado * 0.11);
    }
...
Console.WriteLine("\n Programa finalizado!");
Console.WriteLine("\n ----------------------");
Console.WriteLine($"\n Valor total da folha de pagamento: {totalpag.ToString("F")}");
